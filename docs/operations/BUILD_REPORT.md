...
The source package is Vercel-compatible through `Dockerfile`, `DEPLOY_VERCEL.md`, and `.dockerignore`. Do not commit `.env` values or provider credentials.
